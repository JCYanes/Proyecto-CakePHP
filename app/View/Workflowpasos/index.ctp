<div class="workflowpasos index">
	<h2><?php echo __('Workflowpasos'); ?></h2>
	...
	<?php foreach ($workflowpasos as $workflowpaso): ?>
	<tr>
		<td><?php echo h($workflowpaso['Workflowpaso']['id']); ?>&nbsp;</td>
		<td><?php echo h($workflowpaso['Workflowpaso']['name']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $workflowpaso['Workflowpaso']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $workflowpaso['Workflowpaso']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $workflowpaso['Workflowpaso']['id']), null, __('Are you sure you want to delete # %s?', $workflowpaso['Workflowpaso']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>

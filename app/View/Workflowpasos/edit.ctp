...
<?php echo $this->Form->create('Workflowpaso'); ?>
	<fieldset>
		<legend><?php echo __('Edit Workflowpaso'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Workflowpaso.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Workflowpaso.id'))); ?></li>
